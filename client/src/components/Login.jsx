...
export default function Login() {
  ...
  return (
    <div className="min-h-screen  bg-stone-200 border-b border-stone-300 pt-15 flex items-center justify-center px-4">
      <style>{`
      ...
      <div className="w-full max-w-[420px]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <h1 className="font-playfair text-[48px] font-black leading-[1.05] tracking-tight text-zinc-900 mb-1">
          Sign<br />
          <span className="font-playfair italic text-stone-400">In.</span>
        </h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end -mt-3 mb-8">
            <a
              href="#"
              className="text-[11px] tracking-wide text-stone-400 border-b border-stone-300 pb-px hover:text-zinc-900 hover:border-zinc-900 transition-colors"
            >
              Forgot password?
            </a>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-zinc-900 text-[#f0ede8] text-[11px] font-medium tracking-[0.22em] uppercase rounded-sm
        ...
        <p className="text-center text-[12px] text-stone-400 mt-7">
          ...
          <Link to="/Register" className="text-zinc-900 font-medium border-b border-zinc-900 pb-px hover:text-stone-500 hover:border-stone-500 transition-colors">
            Create one
          </Link>
        </p>
